...
- [ ] Confirm that no full historical dataset or generated model artifact has been added to the public repository.
...
- Raw market or private data not explicitly approved for public GitHub.
